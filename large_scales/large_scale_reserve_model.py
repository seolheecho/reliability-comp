...
def reserve_reliability_model(data, renewable):
    ...
    m.reserve_ratio = pyo.Param(within=pyo.NonNegativeReals, initialize=0.2)
    ...
    def reserve_capacity(m, i, t, n, b):
        return sum(m.cap_rev[i,k,t,n,b] for k in m.dispatch_gen) >= m.reserve_ratio * sum(m.cap_opt[i,k,t,n,b] for k in m.dispatch_gen)
...
if __name__ == "__main__":
    formulation = 'reserve'    # no, reserve, n-1, n-2, dual-no, dual-yes
